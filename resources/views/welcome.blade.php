...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{ asset('assets') }}/img/icon2.png" />
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Restoran Padang</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Selamat datang di Restoran Padang! Nikmati cita rasa autentik masakan Padang yang menggugah selera. </h2>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <p class="text-white-50">
                            RM Padang dibuat untuk memudahkan user untuk mengelola web.
                        </p>
                    </div>
                </div>
                <img class="" src="{{ asset('img') }}/bg.jpg" alt="..." />
            </div>
        </section> -->
        <!-- Menus -->
        <section class="menus-section bg-light" id="menus">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="{{ asset('storage/menu') }}/bg.jpeg" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Masakan Padang</h4>
                            <p class="text-black-50 mb-0">Masakan Padang adalah kuliner khas Sumatera Barat yang terkenal dengan kelezatan dan kekayaan rasa. 
                                Dimasak dengan rempah-rempah khas Indonesia, dengan ciri khas penggunaan santan kental dan bumbu yang melimpah, 
                                menciptakan rasa yang gurih, pedas, dan menggugah selera. 
                                Setiap sajian mencerminkan tradisi dan budaya Minangkabau yang kaya akan warisan kuliner.</p>
                        </div>
                    </div>
                </div>
                <!-- Menu One Row-->
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="{{ asset('storage/menu') }}/nasi_gulai_tunjang.jpg" alt="..."/></div>
                    <div class="col-lg-6">
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="{{ asset('storage/menu') }}/sate_padang.jpg" alt="..." /></div>
                ...
                <!-- Menu One Row-->
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="{{ asset('storage/menu') }}/susu.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="menu-text w-100 my-auto text-center text-lg-left">

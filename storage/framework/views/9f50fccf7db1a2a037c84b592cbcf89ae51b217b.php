<?php $__env->startSection('content-guest'); ?>
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('../../img/Rendang Daging.jpg');">
                ...
                <form role="form" class="text-start" method="POST" action="<?php echo e(route('login')); ?>">
                  ...
                  <div class="my-3">
                    <div class="input-group input-group-outline <?php echo e($errors->has('username') ? ' has-danger' : ''); ?>">
                      ...
                      <input type="username" name="username" value="<?php echo e(old('username')); ?>" id="username" class="form-control">
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['titlePage' => 'Login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Restoran-Master\resources\views/auth/login.blade.php ENDPATH**/ ?>